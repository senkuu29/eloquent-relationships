        ...
        <div class="card mt-5">
            <div class="card-body">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        {{-- perulangan untuk data posts  yang dikirim oleh controller --}}
                        @foreach($posts as $post)
                            <tr>
                                <td>{{ $post->title }}</td>
                                <td>
                                    {{-- menampilkan relasi comments dan menggunakan foreach karena datanya > 1 --}}
                                    @foreach($post->comments()->get() as $comment)
                                    {{-- comments() merupakan relasi yang telah di buat di dalam model post --}}
